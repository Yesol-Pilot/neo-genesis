...
TOOL_POLICIES: dict[str, ToolPolicy] = {
    ...
    "refresh_callable_tools_registry": ToolPolicy("G2", "local callable tools registry refresh", (CONTROL_AUTHORITY, CONTROL_TOOL_POLICY)),
    "refresh_external_tool_capability_registry": ToolPolicy("G2", "external capability registry refresh", (CONTROL_AUTHORITY, CONTROL_TOOL_POLICY)),
    ...
    "comfyui_stop": ToolPolicy("G3", "local GPU service stop", (CONTROL_AUTHORITY, CONTROL_TOOL_POLICY)),
