# Neo Genesis Revenue OS telemetry Windows Task Scheduler wrapper
# Registered as 'NeoGenesisRevenueTelemetry' daily 09:35 KST

$ErrorActionPreference = "Stop"

$repoRoot = "D:\00.test\neo-genesis"
$pythonExe = "C:\Users\yesol\miniconda3\python.exe"
$scriptPath = "scripts\revenue_os\revenue_telemetry.py"
$jobName = "revenue_telemetry"
...
try {
    "=== Neo Genesis Revenue OS Telemetry ===" | Tee-Object -FilePath $logFile -Append
    "Started: $(Get-Date -Format o)" | Tee-Object -FilePath $logFile -Append
    "Python: $pythonExe" | Tee-Object -FilePath $logFile -Append
    "Script: $scriptPath --days 7" | Tee-Object -FilePath $logFile -Append
    ...
    $proc = Start-Process -FilePath $pythonExe `
        -ArgumentList @($scriptPath, "--days", "7") `
