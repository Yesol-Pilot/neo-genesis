# Neo Genesis Revenue OS weekly review Windows Task Scheduler wrapper
# Registered as 'NeoGenesisWeeklyReview' weekly Monday 09:00 KST

$ErrorActionPreference = "Stop"

$repoRoot = "D:\00.test\neo-genesis"
$pythonExe = "C:\Users\yesol\miniconda3\python.exe"
$scriptPath = "scripts\revenue_os\weekly_revenue_review.py"
...
try {
    "=== Neo Genesis Revenue OS Weekly Review ===" | Tee-Object -FilePath $logFile -Append
